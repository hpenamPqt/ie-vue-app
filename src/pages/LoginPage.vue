<template style="border: 1px solid green">
...
.login-container {
  ...
  /* background-image: url(https://images.unsplash.com/photo-1664993981663-198df2c9b05f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMjN8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=400&q=60); */
...
.login-container:after {
	...
	bottom: 0;
	left: 0;
	background-image: radial-gradient(ellipse at left bottom, rgba(22, 24, 47, 0.506) 0%,rgba(38, 20, 72, 0.651) 59%, rgba(17, 27, 75, 0.727) 100%);
